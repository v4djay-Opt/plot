...
export const metadata: Metadata = {
  ...
  description:
    'Affordable residential plots in Gorakhpur, UP. GDA approved zones. Ideal for end-users & investors. Call 09311122787 â€” plotsgurgaon.in',
  alternates: {
    canonical: 'https://plotsgurgaon.in/plots-in-gorakhpur',
  },
  openGraph: {
    url: 'https://plotsgurgaon.in/plots-in-gorakhpur',
    title: 'Residential Plots in Gorakhpur | Affordable Land UP â€” plotsgurgaon.in',
    description:
      'Affordable residential plots in Gorakhpur, UP. GDA approved zones. Ideal for end-users & investors. Call 09311122787 â€” plotsgurgaon.in',
    images: [
      {
