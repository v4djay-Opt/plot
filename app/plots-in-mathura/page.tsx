...
export const metadata: Metadata = {
  ...
  description:
    'Verified residential plots in Mathura, UP. Near Yamuna Expressway. Great for investors & religious destination buyers. Call 09311122787 â€” plotsgurgaon.in',
  alternates: {
    canonical: 'https://plotsgurgaon.in/plots-in-mathura',
  },
  openGraph: {
    url: 'https://plotsgurgaon.in/plots-in-mathura',
    title: 'Residential Plots in Mathura | Land Near Vrindavan â€” plotsgurgaon.in',
    description:
      'Verified residential plots in Mathura, UP. Near Yamuna Expressway. Great for investors & religious destination buyers. Call 09311122787 â€” plotsgurgaon.in',
    images: [
      {
