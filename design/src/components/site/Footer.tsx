...
const cityLinks = [
  { label: "Plots in Gurgaon", to: "/plots-in-gurgaon" as const },
  { label: "Plots in Sohna", to: "/plots-in-sohna" as const },
  { label: "Plots in Jhajjar", to: "/plots-in-jhajjar" as const },
];
        ...
        <div className="grid gap-10 md:grid-cols-12">
          <div className="md:col-span-5">
            <Link to="/" className="inline-flex items-center gap-2.5">
              <span className="grid size-10 place-items-center rounded-md bg-secondary font-display text-lg font-bold text-secondary-foreground">
                P
              </span>
          ...
          <div className="md:col-span-2">
            <h4 className="font-display text-xs font-semibold uppercase tracking-[0.2em] text-secondary">
              Explore
            </h4>
            <ul className="mt-5 space-y-2.5 text-sm text-primary-foreground/75">
              {navLinks.map((l) => (
                <li key={l.to}>
                  <Link to={l.to} className="inline-flex items-center gap-1.5 transition hover:text-secondary">
