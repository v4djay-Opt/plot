...
export const CITY_CONFIGS: Record<CitySlug, CityConfig> = {
  ...
  jhajjar: {
    name: 'Jhajjar',
    h1Title: 'Residential Plots in Jhajjar Under ₹50 Lakh "” Verified & DTCP Approved',
    ...
    faqs: [
      ...
      { q: 'What plot sizes are available in Jhajjar?', a: 'Jhajjar plots range from 200 sq yd to large 500–600 sq yd parcels, ideal for villas, farmhouses or future resale.' },
      ...
      { q: 'How is connectivity from Jhajjar to Gurgaon and Delhi?', a: 'Jhajjar is well connected via the KMP Expressway and Bahadurgarh Road, with travel time to Gurgaon around 60–75 minutes.' },
    ...
    priceTable: [
      { sector: 'Jhajjar Highway', size: '300–600 Sq Yd', priceRange: '₹18 Lakh – ₹35 Lakh', approval: 'DTCP' },
      { sector: 'Jhajjar Town', size: '200–400 Sq Yd', priceRange: '₹12 Lakh – ₹25 Lakh', approval: 'DDJAY' },
    ...
    investorPoints: [
      ...
      'AIIMS Jhajjar operational since 2023 "” healthcare corridor driving residential demand.',
