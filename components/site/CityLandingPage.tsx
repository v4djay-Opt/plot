...
export const CITY_CONFIGS: Record<CitySlug, {
  ...
  gurgaon: {
    name: 'Gurgaon',
    h1Title: 'Residential Plots in Gurgaon â€” Premium Verified Options From â‚¹1 Crore',
    ...
    bullets: [
      ...
      { title: 'High Appreciation', desc: 'Sectors along Dwarka Expressway have grown 18â€“22% YoY.', icon: 'trend' },
    ...
    nearby: [
      ...
      { label: 'Plots in Jhajjar', href: '/plots-in-jhajjar', detail: 'Large-format residential plots' },
    ...
    priceTable: [
      { sector: 'Sector 102', size: '200â€“300 Sq Yd', priceRange: 'â‚¹45 Lakh â€“ â‚¹65 Lakh', approval: 'HRERA' },
      { sector: 'Sector 65', size: '200â€“400 Sq Yd', priceRange: 'â‚¹1.2 Cr â€“ â‚¹2.5 Cr', approval: 'HRERA' },
      { sector: 'Dwarka Expressway', size: '300â€“500 Sq Yd', priceRange: 'â‚¹2.5 Cr â€“ â‚¹4 Cr+', approval: 'HRERA' },
      { sector: 'Sector 84', size: '200â€“350 Sq Yd', priceRange: 'â‚¹80 Lakh â€“ â‚¹1.5 Cr', approval: 'HRERA' },
      { sector: 'Sohna Road', size: '150â€“250 Sq Yd', priceRange: 'â‚¹35 Lakh â€“ â‚¹60 Lakh', approval: 'HRERA' },
    ],
    investorPoints: [
      'Sectors 65 & 84 have delivered 18â€“22% YoY appreciation since 2021.',
      'Dwarka Expressway is the next Golf Course Road â€” infrastructure + metro expansion.',
    ...
    homebuyerPoints: [
      ...
      'Ready-to-move plots with possession â€” start construction within 90 days of registry.',
    ...
    siteVisitSteps: [
      ...
      'Our advisor confirms the date, picks you up and shows 3â€“5 verified plots.',
      'Shortlist your favourite, review documents and get registry assistance.',
    ],
  },
  sohna: {
    name: 'Sohna',
    h1Title: 'Residential Plots in Sohna â€” Affordable Near Gurgaon',
    ...
    bullets: [
      { title: 'Entry-Level Pricing', desc: 'Plots starting from â‚¹9.5 Lakh â€” ideal for first-time investors.', icon: 'trend' },
    ...
    nearby: [
      ...
      { label: 'Plots in Jhajjar', href: '/plots-in-jhajjar', detail: 'Lower entry prices, larger parcels' },
    ...
    priceTable: [
      { sector: 'Sohna Road', size: '150â€“250 Sq Yd', priceRange: 'â‚¹25 Lakh â€“ â‚¹35 Lakh', approval: 'HRERA' },
      { sector: 'Sohna Town', size: '200â€“400 Sq Yd', priceRange: 'â‚¹18 Lakh â€“ â‚¹40 Lakh', approval: 'DTCP' },
      { sector: 'Sector 2 Sohna', size: '200â€“300 Sq Yd', priceRange: 'â‚¹20 Lakh â€“ â‚¹32 Lakh', approval: 'HRERA' },
      { sector: 'Sector 5 Sohna', size: '150â€“250 Sq Yd', priceRange: 'â‚¹15 Lakh â€“ â‚¹28 Lakh', approval: 'DTCP' },
    ],
    investorPoints: [
      'Sohna is the next big corridor after Dwarka Expressway â€” entry prices still 60% below Gurgaon.',
      'Elevated corridor & metro extension will cut commute to Cyber City to 20 minutes.',
      'Major developers (DLF, Sobha, Godrej) already launching â€” land values rising fast.',
      'Ideal for 3â€“5 year horizon: buy plot now, sell or build as prices appreciate.',
    ],
    homebuyerPoints: [
      'Sohna Road offers gated societies with schools, hospitals and daily markets.',
      'Larger plot sizes (300â€“500 sq yd) at a fraction of Gurgaon cost.',
      'Ready registry plots with HRERA/DTCP approval and bank loan eligibility.',
      'Clean environment, less congestion â€” ideal for families seeking space.',
    ],
    siteVisitSteps: [
      'Call 09311122787 or fill the form to book a free Sohna site visit.',
      'Visit 3â€“5 approved plots with our advisor, compare locations & prices.',
      'Get document verification, loan guidance and registry support.',
    ],
  },
  jhajjar: {
    name: 'Jhajjar',
    h1Title: 'Residential Plots in Jhajjar Under â‚¹50 Lakh â€” Verified & DTCP Approved',
    ...
    intro: 'Large residential plots in Jhajjar at unbeatable per-sq-yd rates. RERA verified.',
    body: 'Jhajjar offers the largest plot sizes in the NCR belt at the most competitive rates. With the KMP Expressway, AIIMS Jhajjar, and upcoming industrial corridors driving growth, the district is rapidly transforming into a high-potential residential and investment market.',
    bullets: [
      { title: 'Large Plot Sizes', desc: '500â€“600 sq yd plots widely available.', icon: 'pin' },
    ...
    priceTable: [
      { sector: 'Jhajjar Highway', size: '300â€“600 Sq Yd', priceRange: 'â‚¹18 Lakh â€“ â‚¹35 Lakh', approval: 'DTCP' },
      { sector: 'Jhajjar Town', size: '200â€“400 Sq Yd', priceRange: 'â‚¹12 Lakh â€“ â‚¹25 Lakh', approval: 'DDJAY' },
      { sector: 'Bahadurgarh Road', size: '500â€“1000 Sq Yd', priceRange: 'â‚¹35 Lakh â€“ â‚¹60 Lakh', approval: 'DTCP' },
    ],
    investorPoints: [
      'Lowest per-sq-yd price in the entire Gurgaon influence zone â€” high upside.',
      'KMP Expressway + Reliance MET City = industrial & logistics boom in 3â€“5 years.',
      'AIIMS Jhajjar operational since 2023 â€” healthcare corridor driving residential demand.',
      'Large plots (500â€“1000 sq yd) ideal for farmhouse, villa or future subdivision.',
    ],
    homebuyerPoints: [
      'DDJAY plots under â‚¹50 lakh with registry-ready possession.',
      'Wide roads, sewer, water & electricity already laid in approved sectors.',
      '60â€“75 minutes to Gurgaon via KMP â€” manageable commute for remote workers.',
      'Bank loans (SBI, HDFC, PNB) available on approved DTCP/DDJAY layouts.',
    ],
    siteVisitSteps: [
      'Call 09311122787 to schedule a free Jhajjar site visit.',
      'Our advisor shows 3â€“5 DTCP/DDJAY approved plots with title verification.',
  ...
  mathura: {
    ...
    body: 'Mathura, the birthplace of Lord Krishna and part of the Braj region, is witnessing rapid real estate development along the Yamuna Expressway and Delhiâ€“Mumbai Industrial Corridor. With improved connectivity to Agra, Delhi and Jaipur, residential plots in the Vrindavan and Chaumuhan belt offer a unique blend of spiritual living and modern infrastructure at highly affordable prices.',
    bullets: [
      { title: 'Yamuna Expressway', desc: 'Direct 2-hour connectivity to Delhi NCR.', icon: 'pin' },
      { title: 'Affordable Entry', desc: 'Plots starting from â‚¹8 Lakh â€” lowest in the NCR belt.', icon: 'trend' },
    ...
    faqs: [
      ...
      { q: 'What is the price range of plots in Mathura?', a: 'Plots in Mathura and the Vrindavan belt start from around â‚¹8 lakh and go up to â‚¹40 lakh in premium gated communities.' },
      ...
      { q: 'How is connectivity from Mathura to Delhi and Agra?', a: 'Mathura is on the Delhiâ€“Agra Yamuna Expressway, with Delhi roughly 160 km (2 hours) and Agra roughly 55 km (1 hour) away.' },
    ...
    priceTable: [
      { sector: 'Vrindavan Road', size: '200â€“400 Sq Yd', priceRange: 'â‚¹10 Lakh â€“ â‚¹25 Lakh', approval: 'UP RERA' },
      { sector: 'Chaumuhan', size: '300â€“500 Sq Yd', priceRange: 'â‚¹15 Lakh â€“ â‚¹30 Lakh', approval: 'UP RERA' },
      { sector: 'Goverdhan Road', size: '200â€“300 Sq Yd', priceRange: 'â‚¹8 Lakh â€“ â‚¹18 Lakh', approval: 'DTCP' },
      { sector: 'Refinery Area', size: '300â€“600 Sq Yd', priceRange: 'â‚¹20 Lakh â€“ â‚¹40 Lakh', approval: 'UP RERA' },
    ],
    investorPoints: [
      'Yamuna Expressway + DMIC = industrial corridor appreciation 12â€“16% YoY.',
      'Tourism economy (Braj, Vrindavan) drives rental demand for homestays & guesthouses.',
      'Entry price under â‚¹10 lakh â€” lowest in NCR belt with highest upside.',
    ...
    homebuyerPoints: [
      ...
      'Schools, hospitals and daily markets within 2â€“3 km of all listed sectors.',
      'Bank loans available on approved layouts â€” construction can start within 60 days.',
    ],
    siteVisitSteps: [
      'Call 09311122787 to book a free Mathura/Vrindavan site visit.',
      'Visit 3â€“5 UP RERA approved plots with our local advisor.',
  ...
  gorakhpur: {
    ...
    faqs: [
      ...
      { q: 'What is the starting price of plots in Gorakhpur?', a: 'Plots around GIDA sectors start from approximately â‚¹10 lakh, with larger parcels up to â‚¹50 lakh near the airport corridor.' },
    ...
    priceTable: [
      { sector: 'GIDA Sector 1', size: '200â€“400 Sq Yd', priceRange: 'â‚¹12 Lakh â€“ â‚¹25 Lakh', approval: 'UP RERA' },
      { sector: 'GIDA Sector 2', size: '200â€“300 Sq Yd', priceRange: 'â‚¹15 Lakh â€“ â‚¹28 Lakh', approval: 'UP RERA' },
      { sector: 'Medical College Road', size: '150â€“250 Sq Yd', priceRange: 'â‚¹10 Lakh â€“ â‚¹20 Lakh', approval: 'DTCP' },
      { sector: 'Airport Corridor', size: '300â€“500 Sq Yd', priceRange: 'â‚¹25 Lakh â€“ â‚¹45 Lakh', approval: 'UP RERA' },
    ],
    investorPoints: [
      'GIDA industrial belt = employment-driven residential demand for next decade.',
      'Gorakhpur Link Expressway under construction â€” connectivity premium incoming.',
      'Airport expansion will unlock tourism + business travel demand.',
      'Entry price â‚¹10â€“15 lakh â€” among the lowest in Eastern UP with strongest upside.',
    ],
    homebuyerPoints: [
    ...
    siteVisitSteps: [
      ...
      'Our advisor shows 3â€“5 GIDA & airport corridor plots with document checks.',
      'Compare locations, verify approvals and get end-to-end purchase support.',
    ],
  },
  ayodhya: {
    name: 'Ayodhya',
    h1Title: 'Residential Plots in Ayodhya â€” High Growth Investment Zone 2026',
    ...
    faqs: [
      { q: 'Why buy a plot in Ayodhya now?', a: 'Ayodhya is experiencing unprecedented infrastructure investment â€” international airport, expressway, railway expansion and tourism growth â€” making it one of India\'s highest-potential micro-markets.' },
      { q: 'What is the price range for plots in Ayodhya?', a: 'Ayodhya plots range from â‚¹12 lakh in emerging pockets to â‚¹80+ lakh in premium riverfront and temple-proximity locations.' },
    ...
    priceTable: [
      { sector: 'Ram Janmabhoomi Road', size: '200â€“400 Sq Yd', priceRange: 'â‚¹15 Lakh â€“ â‚¹35 Lakh', approval: 'UP RERA' },
      { sector: 'Faizabad Road', size: '300â€“500 Sq Yd', priceRange: 'â‚¹25 Lakh â€“ â‚¹50 Lakh', approval: 'UP RERA' },
      { sector: 'Sarayu Riverfront', size: '200â€“350 Sq Yd', priceRange: 'â‚¹30 Lakh â€“ â‚¹60 Lakh', approval: 'UP RERA' },
      { sector: 'Deokali', size: '150â€“300 Sq Yd', priceRange: 'â‚¹12 Lakh â€“ â‚¹28 Lakh', approval: 'DTCP' },
    ],
    investorPoints: [
      ...
      'Government-backed development with UP RERA â€” lowest risk, highest reward.',
    ],
    homebuyerPoints: [
      ...
      'Direct flights from Delhi, Mumbai, Bengaluru â€” easy access for family visits.',
    ],
    siteVisitSteps: [
  ...
  lucknow: {
    name: 'Lucknow',
    h1Title: 'Residential Plots in Lucknow Under â‚¹50 Lakh â€” LDA Approved',
    ...
    body: 'Lucknow, Uttar Pradesh\'s capital, combines Nawabi heritage with modern infrastructure â€” metro rail, Agra-Lucknow Expressway, IT parks and world-class hospitals. Residential plots in Gomti Nagar, Sushant Golf City and along Amar Shaheed Path offer the perfect balance of capital safety and appreciation in a rapidly expanding Tier-1 city.',
    bullets: [
      { title: 'Metro Connected', desc: 'Rapid transit covering major residential zones.', icon: 'pin' },
      { title: 'Capital Appreciation', desc: 'Consistent 12â€“16% YoY growth in premium sectors.', icon: 'trend' },
    ...
    faqs: [
      { q: 'Which areas in Lucknow are best for plot investment?', a: 'Gomti Nagar, Sushant Golf City, Amar Shaheed Path and Sultanpur Road currently offer the strongest mix of metro connectivity, planned development and 12â€“16% YoY appreciation.' },
      ...
      { q: 'What is the price range for plots in Lucknow?', a: 'Lucknow plots range from â‚¹25 lakh in emerging sectors to â‚¹2+ crore in premium Gomti Nagar and golf-facing locations.' },
      ...
      { q: 'Can I get a home loan for a Lucknow plot?', a: 'Yes. We assist with plot + construction loans from SBI, HDFC, ICICI, Axis and PNB â€” usually up to 75% of plot value for approved projects.' },
    ],
    priceTable: [
      { sector: 'Gomti Nagar', size: '200â€“400 Sq Yd', priceRange: 'â‚¹50 Lakh â€“ â‚¹1.2 Cr', approval: 'UP RERA' },
      { sector: 'Sushant Golf City', size: '200â€“350 Sq Yd', priceRange: 'â‚¹40 Lakh â€“ â‚¹90 Lakh', approval: 'UP RERA' },
      { sector: 'Amar Shaheed Path', size: '150â€“300 Sq Yd', priceRange: 'â‚¹30 Lakh â€“ â‚¹70 Lakh', approval: 'UP RERA' },
      { sector: 'Sultanpur Road', size: '200â€“400 Sq Yd', priceRange: 'â‚¹25 Lakh â€“ â‚¹60 Lakh', approval: 'DTCP' },
    ],
    investorPoints: [
      'Gomti Nagar & Golf City have delivered consistent 12â€“16% YoY appreciation.',
    ...
    homebuyerPoints: [
      ...
      'UP RERA registered plots with ready possession â€” start building in 60 days.',
  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 md:px-6 md:py-20">
        ...
        <h2 className="mt-3 font-serif text-3xl font-bold leading-tight text-foreground sm:text-4xl">
          Investor or Home Buyer â€” Which Plot is Right for You?
        </h2>
