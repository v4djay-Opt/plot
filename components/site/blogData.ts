...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Jhajjar, on the other hand, is the budget-friendly play. Plots are 30–45% cheaper, with strong upside as the AIIMS-2 corridor and KMP industrial belt continue to scale.",
      "If you're an end-user planning to build within 2 years, Sohna usually wins. If you're a long-horizon investor with a 5–7 year view, Jhajjar offers better entry pricing.",
    ],
  },
  {
